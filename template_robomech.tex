...
\begin{document}
\makeatletter
\title{　視覚と行動の end-to-end 学習により経路追従行動を模倣する手法の提案}
{―シナリオ駆動型ナビゲーションのための学習フレームワークの構築と検証―}
{English Title: Times New Roman, 12pt}
{-English Subtitle: Times New Roman, 10pt-}

\author{
\begin{tabular}{ll}
 \hspace{1zw}○正\hspace{1zw}石黒　巧 (千葉工大)& \\
 \hspace{1zw}学\hspace{1zw}（）\\
 % ※協賛・後援団体の会員資格で発表される場合は「正・学」は不要です。
 \end{tabular}
 % &\\
 \vspace{1zh} \\
 \begin{tabular}{l}
{\small Takumi ISHIGURO, cit
 }\\
 {\small name, cit}\\
